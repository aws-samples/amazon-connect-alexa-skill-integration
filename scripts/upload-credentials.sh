...
VENDOR_ID="<REPLACE_ME- Alexa Developer Vendor ID>"
CLIENT_ID="<REPLACE_ME- Alexa Client ID>"
CLIENT_SECRET="<REPLACE_ME- ALexa Client Secret>"
REFRESH_TOKEN="<REPLACE_ME- Refresh Token>"
